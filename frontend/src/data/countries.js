// Static reference list for the country filter dropdown: name + ISO 3166-1 alpha-2 code.
// The alpha-2 code is sent to the backend as `countryCode` to restrict city search results.
export const COUNTRIES = [
  ...
  { name: "Kuwait", code: "KW" }, { name: "Laos", code: "LA" }, { name: "Latvia", code: "LV" },
  { name: "Lebanon", code: "LB" }, { name: "Lithuania", code: "LT" }, { name: "Luxembourg", code: "LU" },
  { name: "Malaysia", code: "MY" }, { name: "Maldives", code: "MV" }, { name: "Malta", code: "MT" },
  { name: "Mauritius", code: "MU" }, { name: "Mexico", code: "MX" }, { name: "Monaco", code: "MC" },
